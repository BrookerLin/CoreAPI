...
namespace CoreAPI.Controllers
{
    ...
    public class DepartmentsController : ControllerBase
    {
        ...
        // GET: api/Departments/1/Counts
        [HttpGet("{departmentId:int}/Counts")]
        public async Task<ActionResult<IEnumerable<VwDepartmentCourseCount>>> GetDepartmentCourseCount(int departmentId)
        {
            ...
            if (vwDepartmentCourseCount == null)
            {
                return NotFound();
            }
