...
namespace CoreAPI.Migrations
{
    ...
    [Migration("20200813181417_Course_Add_DateModified")]
    partial class Course_Add_DateModified
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreAPI.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreAPI.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("CoreAPI.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreAPI.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("CoreAPI.Models.CourseInstructor", b =>
                {
                    ...
                    b.HasOne("CoreAPI.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("CoreAPI.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("CoreAPI.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("CoreAPI.Models.OfficeAssignment", b =>
                {
                    b.HasOne("CoreAPI.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("CoreAPI.Models.OfficeAssignment", "InstructorId")
